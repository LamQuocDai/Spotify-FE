import { IconHome, IconSearch, IconArticle, IconLogout } from "@tabler/icons-react";
    ...
    return (
        <div className="flex h-[10vh] flex-row items-center text-white bg-black">
            <div className="flex flex-1 flex-row w-full items-center">
                <img className="h-14 cursor-pointer" src="https://getheavy.com/wp-content/uploads/2019/12/spotify2019-830x350.jpg" onClick={() => setCurrentView("main")} />
                <IconHome stroke={2} className="mx-2 bg-[#272727] cursor-pointer size-11 border-none bg p-2 rounded-full" onClick={() => setCurrentView("main")} />

                <div className="flex flex-1 flex-row bg-[rgb(39,39,39)] px-4 py-2 items-center rounded-full">
                    <IconSearch stroke={2} className="size-7 cursor-pointer" onClick={handleSearchChange} />
                    <input
                        type="text"
            ...
            <div className="flex flex-row flex-1 items-center justify-end">
                <div className="flex flex-row mx-4 items-center">
                    {user ? (
                        <>
                            <img src={user.avatar || "https://via.placeholder.com/30"} alt="User avatar" className="w-8 h-8 rounded-full mr-2" />
                            <span className="text-md mx-2 font-bold text-white cursor-pointer">{user.first_name || "User"}</span>
                            <button onClick={handleLogout} className="flex items-center text-md mx-2 font-bold text-gray-400 cursor-pointer hover:text-white">
                        ...
                        <>
                            <Link to="/signup">
                                <span className="text-md mx-2 font-bold text-gray-400 cursor-pointer hover:text-white">Đăng ký</span>
                            </Link>
                            <Link to="/login">
