...
import { registerUser } from "../../services/authenticateService";
...
const SignUp = () => {
    ...
    const validateForm = () => {
        ...
        if (!phone) {
            ...
            newErrors.phone = "Số điện thoại không hợp lệ (chỉ chứa số, 10-15 ký tự).";
            isValid = false;
        }
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            if (err.email) {
                newErrors.email = "Email không hợp lệ hoặc đã tồn tại.";
            }
            if (err.phone) {
