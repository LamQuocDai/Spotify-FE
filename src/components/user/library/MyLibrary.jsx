        ...
        <div className="flex flex-row justify-between items-center mx-6">
          <div className="flex flex-row items-center">
            {available && (
              <div className="mr-4 bg-green-500 rounded-full group-hover:block transition-all duration-300 hover:scale-110 hover:bg-green-400">
                <svg
                  ...
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  className="size-12 p-3 text-black"
                >
            ...
            <svg
              ...
              className="size-8"
            >
              <path d="M3 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM8.5 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM15.5 8.5a1.5 1.5 0 0 0 0 3 1.5 1.5 0 0 0 0-3Z" />
            </svg>
          </div>
          ...
          <div className="grid grid-cols-[16px_4fr_2fr_1fr] gap-4 text-sm text-gray-400 border-b border-gray-700/50 pb-2">
            ...
            <div className="flex justify-end">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75V6z"
                  clipRule="evenodd"
                />
              </svg>
            </div>
