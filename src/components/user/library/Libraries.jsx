...
//   console.log(user);
  ...
  return (
    <div
      className={`flex ${
        widthContainer ? "w-[820px]" : "w-[420px]"
      } flex-col bg-[#131313] px-2 mx-2 text-white rounded-lg`}
    >
      <div className="flex flex-row justify-between items-center pt-4 pb-8 px-2">
        ...
        <div className="flex items-center">
          <button
            className="bg-[#272727] flex items-center justify-center h-[36px] px-4 rounded-3xl cursor-pointer hover:bg-[#242424]"
      ...
      <div>
        {widthContainer ? (
          ...
          <IconSearch
            stroke={2}
            className="size-7 mt-2 mb-5 cursor-pointer"
            onClick={() => setWidthContainer(!widthContainer)}
          />
        )}
      </div>
        ...
        {playlists.length == 0 ? (
          <>
            <div className="bg-[#272727] h-36 w-full p-5 rounded-lg">
              ...
              <button className="mt-4 text-sm font-bold bg-white text-black rounded-full py-1.5 px-4">
                Tạo danh sách phát
              </button>
            </div>
            <div className="bg-[#272727] h-36 w-full p-5 rounded-lg">
      ...
      <div className="flex flex-col px-4">
        <div className="flex flex-wrap">
          <span className="text-xs mb-2 mr-7 font-semibold cursor-pointer text-gray-400">
            Pháp lý
          </span>
          <span className="text-xs mb-2 mr-7 font-semibold cursor-pointer text-gray-400">
