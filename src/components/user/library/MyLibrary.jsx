...
const SearchedSong = ({ songs }) => {
    return (
        <div className="flex flex-row items-center mx-6 mt-4">
            <img src="https://i.scdn.co/image/ab67616d00001e02a1c0bb7c9e7c0c7d7c0c5f6a" alt="Danh Doi" className="w-12 h-12" />
            <div className="flex flex-col ml-3">
                <span className="text-white font-bold">Đánh Đổi</span>
                <span className="text-sm text-gray-400">Obito, Shiki, RPT MCK</span>
            </div>
            <button className="ml-auto px-4 py-2 rounded-full border border-gray-500 bg-transparent text-white text-sm hover:border-white transition-colors">Thêm</button>
        </div>
    );
};
